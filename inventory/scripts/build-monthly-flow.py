...
import sys, json, collections, pathlib, shutil, tempfile, os
...
_tmp = os.path.join(tempfile.gettempdir(), "_mflow_tmp.xlsb")
shutil.copyfile(XLSB, _tmp)
wb = open_workbook(_tmp)
